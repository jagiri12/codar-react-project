  ...
  return (
    <footer className="bg-[#1f0101] text-white py-8 md:py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <a href="#" className="p-2 rounded-full hover:bg-red-700 transition-colors">
        ...
        {/* Copyright */}
        <div className="text-center text-gray-400 text-sm border-t border-gray-800 pt-8 mt-8">
